...
import SearchBox from '../../../hive/pages/SearchBox';
...
import KeepMountedModal from '../../../hive/pages/CustomModal';
import '../../../hive/styles/appbar.scss';
import '../../../hive/styles/global.css';

import CustomButton from '../../../components/CustomButton/Custombutton';
import ListComp from '../../../hive/pages/ListComp';
...
console.log(lang,"lang");
  ...
  //   console.log("params from Table",lang)
    ...
    <Button onClick={() => setPinnedColumn(null)}>  {lang ? lang.form.cancel : 'Loading...'}</Button>
        ...
        >
          <DialogContent>
            ...
            >
              <MenuItem value="start with"> {lang ? lang.form.starts : 'Loading...'}</MenuItem>
              <MenuItem value="ends with"> {lang ? lang.form.ends : 'Loading...'}</MenuItem>
              <MenuItem value="containes"> {lang ? lang.form.contains : 'Loading...'}</MenuItem>
              <MenuItem value="option4">  {lang ? lang.form.equal : 'Loading...'}</MenuItem>
          ...
          <DialogActions>
            <Button onClick={() => setFilterDialogOpen(false)}> {lang ? lang.form.cancel : 'Loading...'}</Button>
            <Button onClick={applyFilter}>{lang ? lang.form.apply : 'Loading...'}</Button>
          </DialogActions>
        </Dialog>

...
const [viewModalOpen, setViewModalOpen] = useState(false);
  ...
  return (
    <>
      ...
      >
        <Paper>
        <TableContainer style={{ maxWidth: '100%', height: '500px', overflowY: 'auto' }}>
            <Table style={{ minWidth: 'max-content' }}>
              <DragDropContext onDragEnd={onDragEnd}>
                <Droppable droppableId="columns" direction="horizontal">
                  {(provided) => (
          ...
          <TableBody>
                {(rowsPerPage > 0
                      ...
                      visibleColumns.includes(column.id) ? (
                        ...
                        >
                          {editingRowId === row.id ? (
                            column.id === 'actions' ? (
                              <>
                                <IconButton onClick={() => saveEditing(row.id)}>
                                  <SaveIcon />
                                </IconButton>
                  ...
                  <IconButton className="delete-button" onClick={() => { setDeletingRowId(row.id); setDeleteDialogOpen(true); }}>
                    <DeleteIcon />
                  </IconButton>
                              </>
                            ) : (
...
>
<DialogTitle className="centered-title">User Information</DialogTitle>
